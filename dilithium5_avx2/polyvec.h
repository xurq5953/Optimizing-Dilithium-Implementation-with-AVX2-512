#ifndef PQCLEAN_DILITHIUM5_AVX2_POLYVEC_H
#define PQCLEAN_DILITHIUM5_AVX2_POLYVEC_H
#include "params.h"
#include "poly.h"
#include <stdint.h>
...
void PQCLEAN_DILITHIUM5_AVX2_polyvecl_pointwise_acc_montgomery(poly *w,
        const polyvecl *u,
        const polyvecl *v);

int PQCLEAN_DILITHIUM5_AVX2_polyvecl_chknorm(const polyvecl *v, int32_t B);
...
int PQCLEAN_DILITHIUM5_AVX2_polyveck_chknorm(const polyveck *v, int32_t B);
